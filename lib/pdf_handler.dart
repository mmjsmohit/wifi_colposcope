...
class PDFHandler {
  ...
  Future<void> setUser() async {
    ...
    var comorDB = FirebaseFirestore.instance
        .collection('comorbidities')
        ...
        build: (pw.Context context) {
          return pw.Center(
              child: pw.Column(
                ...
                pw.Text('Address: $address', style: pw.TextStyle(fontSize: 30)),
                pw.Text('Email Address: $email',
                    style: pw.TextStyle(fontSize: 30)),
                pw.Text('Age: $age', style: pw.TextStyle(fontSize: 30)),
                pw.Text('Weight: $weight kgs',
                    style: pw.TextStyle(fontSize: 30)),
                pw.Text('Height: $height cms',
                    style: pw.TextStyle(fontSize: 30)),
    ...
    pdf.addPage(pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Center(
            child: pw.Text(
              'Previous Colposcopy\nResults',
              style: pw.TextStyle(fontSize: 55),
            ),
          );
        }));
            ...
            return pw.Center(
              child: pw.Column(
                children: [
                  ...
                  pw.Text("This Snapshot was captured on:",
                      style: pw.TextStyle(fontSize: 30)),
                  pw.Text(timestamps[i], style: pw.TextStyle(fontSize: 30)),
                ],
              ),
            ); // Center
          },
